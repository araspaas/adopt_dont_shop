...
Pet.create(image: "Bellas-pic", name: "Bella", age: "5", sex: "female", shelter_id: "#{@shelter1.id}")
Pet.create(image: "Bellas-pic", name: "Bella2", age: "5", sex: "female", shelter_id: "#{@shelter1.id}")
Pet.create(image: "maisys-pic", name: "Maisy", age: "6", sex: "female", shelter_id: "#{@shelter2.id}")
Pet.create(image: "Mr.cats-pic", name: "Mr. Cat", age: "9", sex: "male", shelter_id: "#{@shelter3.id}")
Pet.create(image: "franks-pic", name: "Frank", age: "3", sex: "male", shelter_id: "#{@shelter4.id}")
